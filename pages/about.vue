<template>
  <div class="mx-auto flex max-w-8xl flex-col justify-center rounded-full">
    <div
      class="font-inter relative flex overflow-hidden"
      style="background: url('/heroscreen.png') center 40% no-repeat; background-size: cover; height: 45vh">
      <div class="indexSliderImg-light"></div>
      <div class="absolute z-10 w-full" style="top: 50%; left: 50%; transform: translate(-50%, -50%)">
        <h1
          class="text-center text-5xl text-sxvx-light sm:text-7xl"
          style="text-shadow: 1px 2px 5px rgba(0, 0, 0, 0.3)">
          About
        </h1>
        <h1 class="text-center text-xl text-sxvx-light sm:text-xl" style="text-shadow: 1px 2px 5px rgba(0, 0, 0, 0.6)">
          Here the web template with Nuxt 3 Ui .<br />
          Nuxt is an open source framework that makes web development intuitive and powerful. <br />
          Create performant and production-grade full-stack web apps and websites with confidence.
        </h1>
      </div>
    </div>
    <div class="xs:mx-3 mt-2 sm:mx-3 md:mx-10 lg:mx-20">
      <p class="my-5">
        <svg
          class="block h-6 w-auto text-black dark:text-white"
          width="800"
          height="200"
          viewBox="0 0 800 200"
          fill="none"
        ...
        <a href="https://nuxt.com" target="blank">
          <h1 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-xl">
      ...
      <p class="my-5">
        <svg
          ...
          <path
            d="M168 200H279C282.542 200 285.932 198.756 289 197C292.068 195.244 295.23 193.041 297 190C298.77 186.959 300.002 183.51 300 179.999C299.998 176.488 298.773 173.04 297 170.001L222 41C220.23 37.96 218.067 35.7552 215 34C211.933 32.2448 207.542 31 204 31C200.458 31 197.067 32.2448 194 34C190.933 35.7552 188.77 37.96 187 41L168 74L130 9.99764C128.228 6.95784 126.068 3.75491 123 2C119.932 0.245087 116.542 0 113 0C109.458 0 106.068 0.245087 103 2C99.9323 3.75491 96.7717 6.95784 95 9.99764L2 170.001C0.226979 173.04 0.00154312 176.488 1.90993e-06 179.999C-0.0015393 183.51 0.229648 186.959 2 190C3.77035 193.04 6.93245 195.244 10 197C13.0675 198.756 16.4578 200 20 200H90C117.737 200 137.925 187.558 152 164L186 105L204 74L259 168H186L168 200ZM89 168H40L113 42L150 105L125.491 147.725C116.144 163.01 105.488 168 89 168Z"
            fill="rgb(var(--color-primary-DEFAULT))"></path>
          <path
          ...
          <path
            ...
            fill="rgb(var(--color-primary-DEFAULT))"></path></svg
        ><br />
        <a href="https://ui.nuxt.com" target="blank">
          <h1 class="text-xl font-bold tracking-tight text-gray-900 dark:text-white sm:text-xl">
            <span data-v-baf90ddd=""
              >A <span class="text-primary">UI Library</span> for<br class="hidden lg:block" />
              Modern Web Apps</span
            >
          </h1>
        </a>
      </p>
